...
function startChatbotConversation() {
    ...
    botMessage.style.fontFamily = "Helvetica"; // Change the font family here
    botMessage.textContent = "Hi, What is your name?";
...
function showDefaultQuestions() {
    clearQuestions();
    const questions = ["Types of Question?"];
...
function handleQuestion(question) {
    ...
    if (question === "Types of Question?") {
        ...
        let message = `
          ...
          <button class="sub-question" id="sub-question" onclick="handleSubQuestion('How to Research on Best Tokens/Coin Categories ?')">How to Research on Best Tokens/Coin Categories ?</button>
          <button class="sub-question" onclick="handleSubQuestion('How to design a good storyline ?')">How to design a good storyline ?</button>
          <button class="sub-question" onclick="handleSubQuestion('How to decide the supply  ?')">How to decide the supply  ?</button>
         <button class="sub-question" onclick="handleSubQuestion('How to design tokenomics ? ')">How to design tokenomics ? </button>
        <button class="sub-question" onclick="handleSubQuestion('How to design White Paper ?')">How to design White Paper ?</button>
         <button class="sub-question" onclick="handleSubQuestion('How to design the price of a token ?')">How to design the price of a token ?</button>

                  <button class="sub-question" onclick="handleSubQuestion('How to plan a Roadmap ?')">How to plan a Roadmap ?   </button>
        ...
        addBotMessage(message);
            ...
            let message = `
                    ...
                    By following this comprehensive plan, you can effectively market your ICO, attract investors, and build a strong community around your project.
                      ...
                      <button class="sub-question" onclick="handleSubQuestion('What Activity gives big success in ICO ?')">What Activity gives big success in ICO ?</button>
          <button class="sub-question" onclick="handleSubQuestion('Pre launching and Post launching activities')">Pre launching and Post launching activities</button>
          <button class="sub-question" onclick="handleSubQuestion('What is process ICO/IEO/ITO/IDO')">What is process ICO/IEO/ITO/IDO</button>
          <button class="sub-question" onclick="handleSubQuestion('Is PR work on the ICO  ?')">Is PR work on the ICO  ?</button>
          <button class="sub-question" onclick="handleSubQuestion('Crypto influencers really work ?')">Crypto influencers really work ?</button>
            ...
            let message = `
                   Cryptocurrencies have a wide range of use cases, each leveraging the unique features of blockchain technology such as decentralization, security, and transparency. Here are some of the most common use cases for cryptocurrencies:
                    ...
                    By following this comprehensive plan, you can effectively market your ICO, attract investors, and build a strong community around your project.
                      ...
                      <button class="sub-question" onclick="handleSubQuestion('Give Example of Exchange development as a use case')">Give Example of Exchange development as a use case</button>
          <button class="sub-question" onclick="handleSubQuestion('Why is use case important for projects & Community?')">Why is use case important for projects & Community?</button>
          <button class="sub-question" onclick="handleSubQuestion('What is the meaning of Use Case ??')">What is the meaning of Use Case ??</button>
          <button class="sub-question" onclick="handleSubQuestion('Give Examples of Staking in Crypto projects')">Give Examples of Staking in Crypto projects</button>
          <button class="sub-question" onclick="handleSubQuestion('Give example of staking and mlm as use case ')">Give example of staking and mlm as use case </button>
            ...
            let message = `
                    ...
                    <button class="sub-question" onclick="handleSubQuestion('What is the Best Strategy for founder share dilution ?')">What is the Best Strategy for founder share dilution ?</button>
          <button class="sub-question" onclick="handleSubQuestion('How Use Case give extra source of earning to maintain project ?')">How Use Case give extra source of earning to maintain project ?</button>
          <button class="sub-question" onclick="handleSubQuestion('How does a token or Coin project earn money ?')">How does a token or Coin project earn money ?</button>
...
function handleSubQuestion(subQuestion) {
    addUserMessage(subQuestion);
    if (subQuestion === "How to Research on Best Tokens/Coin Categories ?") {
        let message = `
            <strong>How to Research on Best Tokens/Coin Categories ?</strong>
            <ul>
                <li><strong>Blockchain Selection:</strong> Choose the blockchain on which to launch your token (e.g., Ethereum, Binance Smart Chain).</li>
                <li><strong>Smart Contract Development:</strong> Develop and test the smart contracts for your token. Ensure security and functionality.</li>
                <li><strong>Token Minting:</strong> Mint the initial supply of tokens based on your predetermined distribution plan.</li>
            </ul>
        `;
        addBotMessage(message);
    } else if (subQuestion === "How to design a good storyline ?") {
        let message = `
            <strong>How to design a good storyline ?</strong>
            <ul>
                <li><strong>Internal Testing:</strong> Conduct thorough internal testing to identify and fix bugs.</li>
                <li><strong>External Audit:</strong> Engage a reputable third-party security firm to audit your smart contracts.</li>
                <li><strong>Bug Bounty Program:</strong> Launch a bug bounty program to incentivize community testing and reporting of vulnerabilities.</li>
            </ul>
        `;
        addBotMessage(message);
    } else if (subQuestion === "How to decide the supply ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
                <li><strong>Community Building:</strong> Engage with the community through social media, forums, and events.</li>
                <li><strong>Token Launch:</strong> Conduct the token launch event, ensuring smooth distribution and trading.</li>
            </ul>
        `;
        addBotMessage(message);
    }
    ...
    else if (subQuestion === "How to design White Paper ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "How to design the price of a token ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "How to plan a Roadmap ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "What Activity gives big success in ICO ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "Pre launching and Post launching activities") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "What is process ICO/IEO/ITO/IDO") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "Is PR work on the ICO ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "Pre Listing help on ICO ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "Why is use case important for projects & Community?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "Give Example of Exchange development as a use case ") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "What is the meaning of Use Case ??") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "Give Example of Gaming platform as use case for crypto ") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "How to list a token in multiple exchanges ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "How to maintain price in multiple exchanges ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "What is market making ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "What is the Best Strategy for founder share dilution ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "How Use Case give extra source of earning to maintain project ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
    ...
    else if (subQuestion === "How does a token or Coin project earn money ?") {
        let message = `
            <strong>How to decide the supply ?</strong>
            <ul>
                <li><strong>Marketing Campaign:</strong> Develop and execute a comprehensive marketing strategy.</li>
